...
function Editor(container_id, options) {
    ...
    if (!options.skip_load_counter) {
        this.addLoadCounter();
    }
    this.addToolsButton(
        "playnode_button",
        "Play",
        "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0iI2ZmZiIgZD0iTTggNXYxNGwxMS03eiIvPjwvc3ZnPg==",
    ...
    this.addToolsButton(
        "playstepnode_button",
        "Step",
        "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0iI2ZmZiIgZD0iTTggNXYxNGw4LTd6TTIwIDV2MTRoLTR2LTE0eiIvPjwvc3ZnPg==",
    ...
    if (!options.skip_livemode) {
        this.addToolsButton(
            "livemode_button",
            "Live",
            "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PGNpcmNsZSBmaWxsPSIjZmYwMDAwIiBjeD0iMTIiIGN5PSIxMiIgcj0iOCIvPjwvc3ZnPg==",
...
Editor.prototype.onPlayButton = function() {
    ...
    if (graph.status == LGraph.STATUS_STOPPED) {
        button.innerHTML = "<img src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0iI2ZmZiIgZD0iTTYgNnYxMmg0di0xMnpNMTQgNnYxMmg0di0xMnoiLz48L3N2Zz4='/> Stop";
        graph.start();
    } else {
        button.innerHTML = "<img src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0iI2ZmZiIgZD0iTTggNXYxNGwxMS03eiIvPjwvc3ZnPg=='/> Play";
        graph.stop();
    }
};
...
Editor.prototype.onLiveButton = function() {
    ...
    button.innerHTML = !is_live_mode
        ? "<img src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PGNpcmNsZSBmaWxsPSIjZmYwMDAwIiBjeD0iMTIiIGN5PSIxMiIgcj0iOCIvPjwvc3ZnPg=='/> Live"
        : "<img src='data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI+PHBhdGggZmlsbD0iI2ZmZiIgZD0iTTEyIDhjLTIuMjEgMC00IDEuNzktNCA0czEuNzkgNCA0IDQgNC0xLjc5IDQtNC0xLjc5LTQtNC00eiIvPjwvc3ZnPg=='/> Edit";
};
